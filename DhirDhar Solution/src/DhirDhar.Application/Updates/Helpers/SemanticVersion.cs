...
namespace DhirDhar.Application.Updates.Helpers;

/// <summary>
/// Simple, robust Semantic Versioning parser and comparator for DhirDhar releases.
/// Supports versions like "1.0.0", "v1.0.1", "v2.0.0-beta.1", "1.2.3.4".
/// </summary>
